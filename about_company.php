    ...
    <main>
                    ...
                    <div class="col col-lg-5 mb-4">
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="r-progress w-100" style="--value:85;">
                                <span class="text-white font-2">Videography</span>
                                <div class="progress-container mt-2">
                                    <div class="r-progress-bar percentage-label">
                                        <div class="progress-value"></div>
                                    </div>
        ...
        <!-- <section class="section">
            <div class="r-container">
                ...
                <h4 class="text-title text-white fw-bold font-1 lh-1 mb-5">Our Team.</h4>
                <div class="row row-cols-1 row-cols-lg-3">
                    <div class="col">
                        <div class="d-flex flex-column gap-3 text-center  align-items-center">
                            ...
                            <div>
                                <h5 class="text-white font-1">Tyas Kids</h5>
                                <span class="text-gray font-1">Photography</span>
                    ...
                    <div class="col">
                        <div class="d-flex flex-column gap-3 text-center  align-items-center">
                            ...
                            <div>
                                <h5 class="text-white font-1">Helena Kids</h5>
                                <span class="text-gray font-1">Photography</span>
                                <div class="d-flex flex-row gap-3 my-4">
                                    <a type="button" href=""
                                        class="social-item p-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col">
                        <div class="d-flex flex-column gap-3 text-center  align-items-center">
                            ...
                            <div>
                                <h5 class="text-white font-1">Brandon Kids</h5>
                                <span class="text-gray font-1">Photography</span>
                                <div class="d-flex flex-row gap-3 my-4">
                                    <a type="button" href=""
                                        class="social-item p-2 d-flex align-items-center justify-content-center">
